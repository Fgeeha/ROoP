...
**«Очередь индексации переполнена»** — в очереди уже 100 документов. Файл сохранён, но не проиндексирован: дождитесь завершения текущих задач, затем удалите документ и загрузите повторно.
